...
//            }
    ...
    public View createView(final Context context) {
        ...
        if (filterTabsView != null) {
            boolean floatingTabs = MessagesController.getGlobalMainSettings().getBoolean("omnigram_floating_tabs", false);
            filterTabsView.setPadding(0, dp(7), 0, dp(7));
            if (floatingTabs) {
                filterTabsView.setBackground(Theme.createRoundRectDrawable(dp(20), getThemedColor(Theme.key_windowBackgroundWhite)));
                contentView.addView(filterTabsView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 36 + 7 + 7, Gravity.TOP, 12, 6, 12, 0));
            } else {
